...
class Device extends Homey.Device {
  ...
  */
  ...
  getAddress() {
    ...
    if (filled(manual)) {
      this.log('Using manual address from settings', manual);
      return manual;
    }
    ...
    if (filled(discovered)) {
      this.log('Using discovered address', discovered);
      return discovered;
    }
    ...
    if (filled(settingIP)) {
      this.log('Using address from setttings', settingIP);
      return settingIP;
    }
  ...
  */
  ...
  log(...args) {
    ...
    super.log(`[${this.client?.address || ''}] [${this.getData().id}]`, ...args);
  }
