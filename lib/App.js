...
class App extends Homey.App {
  ...
  */
  ...
  registerFlowCards() {
    ...
    // ... then turn off vacant property mode ...
    this.homey.flow.getActionCard('vacant_property_mode_off').registerRunListener(async ({ device }) => {
      await device.onCapabilityVacantPropertyMode(false);
    });

    // ... then turn on vacant property mode ...
    this.homey.flow.getActionCard('vacant_property_mode_on').registerRunListener(async ({ device }) => {
      await device.onCapabilityVacantPropertyMode(true);
    });
    ...
    // ... and vacant property mode is ...
    this.homey.flow.getConditionCard('vacant_property_mode_is').registerRunListener(async ({ device, onoff }) => {
      return device.getCapabilityValue('vacant_property_mode') === onoff;
    });
